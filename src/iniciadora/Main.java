...
public class Main {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Dpto dpto = new Dpto("Ingenier�a de Software", "Sonia Perez Lovelle", "Ingenier�a Inform�tica");
	...
	public static void inicializarDatos(Dpto dpto){
		...
		Docente prof2 = new Docente("85121067683", "Ferm�n Rivas", "Disponible", 4500, 11, "Ninguno", "Ninguno");
		...
		Asignatura asig1 = new Asignatura("Introducci�n a la Programaci�n", "Programaci�n", 'E', 1, "Inform�tica", 1, "Evaluaci�n Final", ensenanzasDpoo);	
		...
		Asignatura asig2 = new Asignatura("Matem�tica Discreta", "Inteligencia Artificial", 'E', 1, "Inform�tica", 1, "Ninguna", ensenanzasMD);	
		...
		Asignatura asig3 = new Asignatura("Dise�o y Programaci�n Orientada a Objetos", "Programaci�n", 'E', 2, "Inform�tica", 1, "Evaluaci�n Final", ensenanzasIP);	
		...
		AsigPorProf asp1 = new AsigPorProf(5, "Introducci�n a la Programaci�n", "Conferencia", "Ferm�n Rivas", 11);
		AsigPorProf asp2 = new AsigPorProf(5, "Matematica Discreta", "Seminario", "Raisa Socorro", 14);
		AsigPorProf asp3 = new AsigPorProf(12, "Dise�o y Programaci�n Orientada a Objetos", "Clase Pr�ctica", "Sonia P�rez", 13);
